...
export default function AccountError({
  ...
  return (
    <div className="aq-card-static p-8 md:p-12 max-w-lg mx-auto my-10 text-center space-y-5 border border-aq-error/10 shadow-aq-sm">
      ...
      <div>
        <h2 className="text-lg font-extrabold text-aq-on-surface tracking-tight">Failed to Load Profile</h2>
        <p className="text-xs text-aq-on-surface-variant mt-1.5 leading-relaxed max-w-sm mx-auto">
          There was an error loading your account information or delivery addresses. Please try again.
        </p>
      </div>
      <div className="flex gap-3 justify-center pt-2">
        ...
        >
          <RefreshCw className="w-3.5 h-3.5" /> Retry Profile
        </Button>
      </div>
    </div>
  );
